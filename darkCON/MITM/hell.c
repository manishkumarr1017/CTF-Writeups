...
int main() 
{
	...
	alarm(0x40);  
    char g[]="13061880230110805485346525688018595113271880103717720219673350299083396780730251766148414377512386061643807530751287373200960399392170617293251618992497053",private[]="9517018167612097404022134757233813893652343928773015789135722992935432221083850650177096647623447125866713084428251292117869997067081889284659234735441603",input[]="4bl3_t0_m4n_1n_th3_m1ddl3_1789}\x00",user_input[63];
    char* y[4];
    int key[4];
    for(int i=0;i<4;i++){
    	y[i]=(char*)malloc(64);
    ...
    char* dec=aes_decrypt(user_input);
    if(!strncmp(dec,"darkCON{d1ff13_h3llm4n_1s_vuln3r",32)){
